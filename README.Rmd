...
As variáveis idade, tenure (que indica quanto tempo o cliente está com a empresa) e número de produtos são as mais importantes para prever o churn, segundo o modelo. Enquanto isso, aspectos geográficos do cliente ou o score de crédito não apresentam grande poder preditivo, o que indica um bom caminho que a empresa pode seguir para tratar o problema.  
